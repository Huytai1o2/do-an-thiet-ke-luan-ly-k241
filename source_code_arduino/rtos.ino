...
// #define AIO_USERNAME "Huytai102"
// #define AIO_KEY “iogerio"
...
// #define PIN D3           // Define the pin (adjust based on your board)
...
// Adafruit_NeoPixel pixels5(4, D5, NEO_GRB + NEO_KHZ800);
// DHT20 dht20;
...
//     analogWrite(D7, distance > 5 ? 0 : 100);
//     vTaskDelay(2000);
...
//     int32_t moisture_value = analogRead(A0);
...
//     uint16_t lightValue = analogRead(A1);
...
#define AP_SSID "project logic design"
